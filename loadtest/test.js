...
// Path adjusted from the official script's './test-data.json': vendored
// here under fixtures/ so it sits alongside the other checked-in test
// assets instead of loose in loadtest/. See .github/docs/PROJECT_STRUCTURE.md.
const jsonRaw = open('./fixtures/test-data.json');
